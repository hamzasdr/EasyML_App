...
class DecisionTreeRegressorParameters extends ParameterStatefulWidget {

  DecisionTreeRegressorParameters({Model stateModel, Function onChanged, Key key}): super(stateModel: stateModel, onChanged: onChanged, key: key);
  @override
  _DecisionTreeRegressorParametersState createState() => _DecisionTreeRegressorParametersState();
}

class _DecisionTreeRegressorParametersState extends ParameterState<DecisionTreeRegressorParameters> {

  static const List<String> _maxFeaturesChoices = const <String>['auto', 'sqrt', 'log2', 'Number', 'Percentage'];
  static const List<String> _criterionChoices = const <String>['mse', 'friedman_mse','mae'];
        ...
        Column(
          ...
          children: <Widget>[
            ...
            NumField(
              ...
              desc: "The maximum depth of the tree.\n"
              ...
              setState(() {
                (widget.stateModel as DecisionTreeRegressorModel).maxDepth = newValue;
                ...
                setValue: (dynamic newValue) {
                  setState(() {
                    if(newValue is double)
                      newValue /= 100.0;
                    (widget.stateModel as DecisionTreeRegressorModel).maxFeatures = newValue;
                  });
                  if(widget.onChanged != null)
                    widget.onChanged();
                }
            ...
            Column(
              children: <Widget>[
                ...
                DynamicField(
                  ...
                  setState(() {
//                          print(newValue);
                    (widget.stateModel as DecisionTreeRegressorModel).criterion = newValue;
                    if(widget.onChanged != null)
                      widget.onChanged();
                  });}),
                ...
                DynamicField(
                    ...
                    setValue: (String newValue) {
                      setState(() {
                        (widget.stateModel as DecisionTreeRegressorModel).splitter = newValue;
                        if(widget.onChanged != null)
                          widget.onChanged();
                      });}),
  ...
  @override
  void update() {
    DecisionTreeRegressorModel _model = (widget.stateModel as DecisionTreeRegressorModel);
