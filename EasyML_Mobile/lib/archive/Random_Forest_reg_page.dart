...
List<String> _criterions = <String>['mse', 'mae'];

class RandomForestRegPage extends StatefulWidget {
  Widget child;
   RandomForestRegressorModel model;
  RandomForestRegPage({this.model});

  @override
  _RandomForestRegPageState createState() => _RandomForestRegPageState();
}

class _RandomForestRegPageState extends State<RandomForestRegPage> with TickerProviderStateMixin {
...
//                        print(widget.model.toJson());
              ...
              Hero(tag: "randomforest_reg", child: SizedBox())
              ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
