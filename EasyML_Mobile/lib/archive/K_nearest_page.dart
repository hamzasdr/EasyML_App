...
List<String> _algorithms = <String>['auto', 'ball_tree','kd_tree', 'brute'];
List<String> _weights = <String>['uniform', 'distance'];

class KnearestPage extends StatefulWidget {
  Widget child;
  KNearestNeighborsClassifierModel model;
  KnearestPage({this.model});

  @override
  _KnearestPageState createState() => _KnearestPageState();
}

class _KnearestPageState extends State<KnearestPage> with TickerProviderStateMixin {

  BooleanWrapper _bootstrapState = BooleanWrapper(initialValue: true);
  int _n_neighborsState;
  String  _algorithmState ;
  dynamic _weightState;
...
//                top: 0,
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  NumField(name:'n_neighbors',value:_n_neighborsState,type: 0 ,setValue: (int newValue) {
                    setState(() {
                      _n_neighborsState = newValue;
                    });}),
                  SizedBox(height: 10),
                ],
              ),
                ...
                children: <Widget>[
                  Column(
                    children: <Widget>[
                      ...
                      DynamicField(name:'criterion',values: _algorithms ,defval: _algorithmState, setValue: (String newValue) {
                        setState(() {
//                          print(newValue);
                          _algorithmState = newValue;
                        });}),
                      DynamicField(name:'weights',values: _weights ,defval: _weightState, setValue: (String newValue) {
                        setState(() {
//                          print(newValue);
                          _weightState = newValue;
                        });}),
                      SizedBox(
                        height: 30,
                      ),
...
//                        print(widget.model.toJson());
              ...
              Hero(tag: "knn_cls", child: SizedBox())
              ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//    return widget.model.fitIntercept != _fitInterceptState || widget.model.normalize != _normalizeState;
    return widget.model.nNeighbors != _n_neighborsState ||
           widget.model.algorithm != _algorithmState ||
           widget.model.weights != _weightState;
  }
}
