...
List<String> _criterions = <String>['mse', 'friedman_mse','mae'];
List<String> _splitters = <String>['best', 'random'];

class DecisionTreeRegPage extends StatefulWidget {
  Widget child;
  DecisionTreeRegressorModel model;
  DecisionTreeRegPage({this.model});

  @override
  _DecisionTreeRegPageState createState() => _DecisionTreeRegPageState();
}

class _DecisionTreeRegPageState extends State<DecisionTreeRegPage> with TickerProviderStateMixin {

  int _max_depthState ;
  String  _criterionState ;
  String  _splitterState ;
...
//  DropDownSelectionWrapper _criterionState = DropDownSelectionWrapper(items: _criterions);
  ...
  void initState() {
    ...
    _splitterState = widget.model.splitter;
              ...
              ExpansionTile(
                ...
                children: <Widget>[
                  Column(
                    children: <Widget>[
//                      HelpDropDown(
//                        dropDownSelectionWrapper: _criterionwrapper,
//                        name: "Optimizer",),
...
//                        dropDownSelectionWrapper: _criterionwrapper,
//                        name: "splitter",),
                      DynamicField(name:'splitter',values: _splitters ,defval: _splitterState, setValue: (String newValue) {
                        setState(() {
//                          print(newValue);
                          _splitterState = newValue;
                        });}),
...
//                        print(widget.model.id);
                              ...
                              widget.model.splitter = _splitterState;
...
//                        print(widget.model.toJson());
              ...
              Hero(tag: "decisiontree_reg", child: SizedBox())
              ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//    return widget.model.fitIntercept != _fitInterceptState || widget.model.normalize != _normalizeState;
    return  widget.model.maxDepth != _max_depthState ||
        widget.model.criterion != _criterionState ||
        widget.model.splitter != _splitterState ||
        widget.model.maxFeatures != _max_featuresState;
  }
