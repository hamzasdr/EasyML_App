...
class DecisionTreeClsPage extends StatefulWidget {
  Widget child;
  DecisionTreeClassifierModel model;
  DecisionTreeClsPage({this.model});

  @override
  _DecisionTreeClsPageState createState() => _DecisionTreeClsPageState();
}

class _DecisionTreeClsPageState extends State<DecisionTreeClsPage> with TickerProviderStateMixin {
...
//                        print(widget.model.toJson());
              ...
              Hero(tag: "decisiontree_cls", child: SizedBox())
              ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
